                                        ...
                                        <ul className="nav navbar-nav mx-auto">
                                            ...
                                            <li className="nav-item dropdown">
                                                ...
                                                <ul className="dropdown-menu" aria-labelledby="servicesDropdown">
                                                    ...
                                                    <li>
                                                        <Link className="dropdown-item" to={"/electricitybillpayment"}>
                                                            <i class="bi bi-currency-rupee"></i>
                                                            Transfer to Bank</Link>
                                                    </li>
                                                    <li>
                                                        <Link className="dropdown-item" to={"/datacardrecharge"}>
                                                            <svg
                                                                className="custom-svg"
                                                                fill="#000000"
                                                                height="64px"
                                                    ...
                                                    <li>
                                                        <Link className="dropdown-item" to={"/broadband"}>
                                                            <i class="bi bi-geo"></i>
                                                            Local Stores</Link>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <Link className="dropdown-item" to={"/landline"}>
                                                            <svg
                                                                className="custom-svg"
                                                                height="64px"
                                                                width="64px"
...
>>>>>>> 42f3a87b75a6600f4105318f4adac283cd91975c
}
